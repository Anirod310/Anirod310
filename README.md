# <img width="150" height="150" alt="image" src="https://github.com/user-attachments/assets/f597a8b7-1390-495a-bb12-2908ded66f83" /> Hey👋
...
- 🌱 Exploring 3D reinforcement learning environments with Unity ML-Agents, planning to dive into robotics simulation with NVIDIA Isaac Sim and learn more about LLMS and CNNs as well.
- ⚙️ Developing primarily in Python and PyTorch.

### 🛠️ Tech Stack
- **Languages:** Python, C, C#, Java
- **Machine Learning:** PyTorch, Gymnasium, Unity ML-Agents
- **Tools & Environments:** Linux (WSL 2), Git, VS Code, MiniConda
